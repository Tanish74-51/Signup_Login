 ...
 * Sign-up
  ...
  * Username creation with constraints
   * Constraints: 4–8 characters long, Must contain at least one alphabet, Allowed special characters: ., -, _
  * Password creation with constraints
   * Constraints: 8 characters long, Must contain alphabets, At least one uppercase letter, Must include digits, Must include special characters
